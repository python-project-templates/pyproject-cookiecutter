...
# -*- coding: utf-8 -*-
#
# {{ cookiecutter.extension_name }} documentation build configuration file, created by
...
#
# The short X.Y version.
_version_py = os.path.join('..', '..', '{{ cookiecutter.extension_name }}', '_version.py')
version_ns = {}
...
htmlhelp_basename = '{{ cookiecutter.extension_name }}doc'
...
latex_documents = [
    (master_doc, '{{ cookiecutter.extension_name }}.tex', '{{ cookiecutter.extension_name }} Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, '{{ cookiecutter.extension_name }}', '{{ cookiecutter.extension_name }} Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, '{{ cookiecutter.extension_name }}', '{{ cookiecutter.extension_name }} Documentation',
     author, '{{ cookiecutter.extension_name }}', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    _dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '{{ cookiecutter.extension_name }}'))
