...
latex_documents = [
    (master_doc, "{{ cookiecutter.name }}.tex", "{{ cookiecutter.name }} Documentation",
...
texinfo_documents = [
    (master_doc, "{{ cookiecutter.name }}", "{{ cookiecutter.name }} Documentation",
     author, "{{ cookiecutter.name }}", "{{cookiecutter.description}}",
     "Miscellaneous"),
]
...
def run_apidoc(_):
    ...
    _dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "{{ cookiecutter.module }}"))
